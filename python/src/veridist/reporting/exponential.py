        ...
        ReportLocale.EN: MappingProxyType(
            {
                ...
                "failure.NO_OBSERVED_EVENTS": "No event was observed; no finite rate estimate exists.",
                "failure.UNBOUNDED_LIKELIHOOD": "The likelihood is unbounded; no finite rate estimate exists.",
        ...
        ReportLocale.FA: MappingProxyType(
            {
                ...
                "failure.UNBOUNDED_LIKELIHOOD": "درست‌نمایی نامتناهی است؛ برآورد نرخ متناهی وجود ندارد.",
        ...
        ReportLocale.DE: MappingProxyType(
            {
                ...
                "failure.NO_OBSERVED_EVENTS": "Kein Ereignis wurde beobachtet; es gibt keine endliche Ratenschätzung.",
                "failure.UNBOUNDED_LIKELIHOOD": "Die Likelihood ist unbeschränkt; es gibt keine endliche Ratenschätzung.",
                "failure.NUMERICAL_OVERFLOW": "Numerischer Überlauf verhinderte eine endliche Schätzung.",
            }
        ),
    }
)
...
def _validate_result(result: ExponentialFit) -> None:
    ...
    if type(result) is ExponentialFitFailure:
        ExponentialFitFailure(result.code, result.observation_count, result.event_count, result.total_time)
        return
