...
Decimal sufficient facts. This ADR is **Accepted**: the formal mutation runner
has retained GitHub Linux evidence, and the documentation gate retains Persian
RTL screenshots for prose, tables, code, and formulae. The retained trace does not prove a
