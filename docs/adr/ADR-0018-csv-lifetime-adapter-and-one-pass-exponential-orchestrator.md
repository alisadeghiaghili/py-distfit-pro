...
formal mutation runner and its GitHub Linux workflow are implemented but have
no retained Linux execution or mutation score; full documentation
table/code/formula RTL render evidence is not complete, and the retained trace does not prove a
