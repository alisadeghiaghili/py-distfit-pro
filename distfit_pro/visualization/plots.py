...
class DistributionPlotter:
    ...
    def plot_comparison(self, figsize: Tuple[int, int] = (14, 10), show_top_n: int = 3) -> Figure:
        ...
        ax1.set_title(fix_rtl_text(f"📊 {t('pdf_comparison')}"), fontsize=13, fontweight='bold')
        ...
        ax2.set_title(fix_rtl_text(f"📈 {t('cdf_comparison')}"), fontsize=13, fontweight='bold')
        ...
        ax3.set_title(fix_rtl_text(f"📐 {t('qq_plot')} ({self.best_model.info.display_name})"), 
        ...
        ax4.set_title(fix_rtl_text(f"📉 {t('pp_plot')} ({self.best_model.info.display_name})"), 
                     fontsize=13, fontweight='bold')
    ...
    def plot_diagnostics(self, figsize: Tuple[int, int] = (14, 10)) -> Figure:
        ...
        ax1.set_title(fix_rtl_text(f"🔍 {t('residual_plot')}"), fontsize=13, fontweight='bold')
        ...
        ax2.set_title(fix_rtl_text(f"📊 {t('residual_distribution')}"), fontsize=13, fontweight='bold')
        ...
        ax3.set_title(fix_rtl_text(f"📉 {t('tail_behavior')}"), fontsize=13, fontweight='bold')
        ax3.legend(fontsize=9)
        ...
        ax4.set_title(fix_rtl_text(f"⚠️ {t('influence_plot')}"), fontsize=13, fontweight='bold')
        ax4.legend(fontsize=9)
        ax4.grid(alpha=0.3)
        
        fig.suptitle(fix_rtl_text(f"{t('diagnostic_plots')} - {model.info.display_name}"), 
